...
@Configuration class ZMarketStreamJoinerListener {
    ...
    fun joinerPurchaseKStream(streamsBuilder: StreamsBuilder): KStream<String, Purchase> {
        ...
        val purchasePatternSerdes = KafkaJacksonConfig.createPurchasePatternJsonSerdes()
        ...
        val rewardAccumulatorSerdes = KafkaJacksonConfig.createRewardAccumulatorJsonSerdes()
